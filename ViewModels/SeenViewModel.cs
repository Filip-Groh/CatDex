...
namespace CatDex.ViewModels {
    public partial class SeenViewModel(ICatRepositoryService catRepositoryService, INavigationService navigationService, IDialogService dialogService) : CatListViewModelBase(catRepositoryService, navigationService, dialogService) {
