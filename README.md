...
**WARNING:** Sometimes the app throws "Process isn't responing", but the app works fine just the error popup keeps appearing. Probably too much work on the main thread.
